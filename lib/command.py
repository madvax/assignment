...
# ==============================================================================
# DICTIONARY
VERSION = "1.1.1"  # Version of the agent
...
OPTIONS:                                                 
  ...
  -v --verbose    Runs the program in verbose mode, default: {verbosity}. 
  -d --debug      Runs the program in debug mode (implies verbose)      
                                                        
EXIT CODES:                                              
       0 - Successful Unit Tests.                       
Non-Zero - One or more unit test failures.              
                                                        
EXAMPLES:                                                
   TODO - I'll make some examples up later.                                 
    """.format(this_file=ME, version=VERSION, verbosity=VERBOSE))
